...
\begin{document}
    ...
    To answer this question, we implemented a file-based \textbf{pipeline} that separates source-specific parsing from shared
    ...
    selects the available source fields and renames them to canonical crop, pathogen, product, and microbe fields.
    Optional columns remain optional. This distinction matters because the European exports do not expose the same
    concepts, and an empty
