...
\begin{document}
    ...
    \begin{abstract}
        ...
        pipeline screening outcomes and known regulatory associations, not independent biological efficacy. In a
        evaluation over 109 crop--pathogen contexts with existing catalogue evidence, the hybrid ranker recovered 93.6\% of held-out BCAs
