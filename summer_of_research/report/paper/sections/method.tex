...
As a preliminary screening step, the pipeline also applies a text-based screening model to the processed records. TF-IDF converts the
...
authorization-derived BCA-related and no-signal outcomes. This screening model reproduces pipeline outcomes; its scores are not
