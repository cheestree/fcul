...
\begin{enumerate}
    ...
    \item \textbf{Recommender system}: rank microbial BCAs for a crop--pathogen query.
\end{enumerate}

The stages are evaluated separately. This keeps data processing, database creation, and recommendation distinct.

As a diagnostic triage step, the pipeline also applies a text classifier to the processed records. TF-IDF converts the
