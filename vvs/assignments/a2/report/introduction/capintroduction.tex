...
The main objective of this assignment is to demonstrate a structured verification strategy for the application. For that reason, the report documents the implemented behavior, the unit, integration, and end-to-end tests that protect it, and the range of successful and bad-path scenarios covered by the suite.
