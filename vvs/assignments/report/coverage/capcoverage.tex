...
The 2 lines without coverage are relative to a try-catch block that is not triggered by any test, as it guards against an \texttt{ReflectiveOperationException} that cannot occur in the current implementation.
