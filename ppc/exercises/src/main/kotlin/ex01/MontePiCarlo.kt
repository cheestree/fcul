...
fun montePiCarloParallel(
    radius: Int,
    vertices: Pair<Point, Point>,
    samples: Int, nThreads: Int = Runtime.getRuntime().availableProcessors(),
    chunkSize: Int = samples / nThreads
): Double {
    val center = circleCenter(vertices.first, vertices.second)
    val radiusSquared = radius * radius
